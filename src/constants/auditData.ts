...
export const AUDIT_DATA: Record<string, AuditContent> = {
  ...
  'Net Profit': {
    title: 'Net Profit',
    value: '$95.2M',
    soWhat: 'Net profitability reaches $95.2M, driven by strong growth in core beverages, but impacted by rising raw milk COGS in Dairy.',
    ...
    trendRows: [
      ['Beverages', '$280M', '14.2%', 'Low'],
      ['Snacks', '$260M', '11.8%', 'Medium'],
      ['Dairy', '$180M', '8.5%', 'High'],
      ['Personal Care', '$131M', '12.1%', 'Medium']
    ]
  },
  'Gross margin %': {
    title: 'Gross margin %',
  ...
  'Gross Profit': {
    title: 'Gross Profit',
    value: '$308.1M',
    soWhat: 'Gross profit contribution stands at $308.1M (36.2% of sales), driven by Beverages and Snacks categories, but restricted by packaging material inflation in Personal Care.',
    ...
    trendRows: [
      ['Beverages', '$280M', '38.45%', '$107.7M'],
      ['Snacks', '$260M', '38.53%', '$100.2M'],
      ['Dairy', '$180M', '38.50%', '$69.3M'],
      ['Personal Care', '$131M', '39.52%', '$51.8M']
    ]
  },
  'Revenue MTD': {
    title: 'Total Revenue',
    value: '$851.2M',
    soWhat: 'MTD revenue reaches $851.2M, showing +8.4% growth compared to last month. Beverages continue to dominate, contributing 37.1% of total sales.',
  ...
  'Launch ROI': {
    ...
    action: 'Approve the $4.2M launch budget and run early cross-promotions with snacks.',
    columns: [
    ...
    trendRows: [
      ['BrandA Premium Energy', '$24.5M', '$12.0M', '2.04x'],
      ['BrandD Organic Yogurt', '$18.2M', '$10.5M', '1.73x'],
      ['Mango Fizz 750ml Launch', '$8.4M', '$4.2M', '2.00x']
    ]
  },
  'Portfolio SKUs': {
    title: 'Active SKUs',
  ...
  'Sunset Candidates': {
    ...
    trendRows: [
      ['Fabric Softener', 'Household', '0.22', '0.81', '$28M'],
      ['Floor Cleaner', 'Household', '0.29', '0.74', '$38M'],
      ['Aloe Face Wash', 'Personal Care', '0.28', '0.78', '$32M'],
      ['BrandB Yogurt 1kg', 'Dairy', '0.35', '0.68', '$42M'],
      ['BrandE Yogurt (Straw)', 'Dairy', '0.29', '0.72', '$35M'],
      ['Choco Wafers', 'Snacks', '0.34', '0.71', '$44M']
    ]
  },
  'Revenue at Risk': {
    title: 'Revenue at Risk',
    value: '$148M',
    soWhat: 'Total revenue exposure is $148M if all 6 sunset candidates are pruned simultaneously without substitution transfer.',
    ...
    trendRows: [
      ['Choco Wafers', 'Snacks', '$44M', '29.7%'],
      ['BrandB Yogurt 1kg', 'Dairy', '$42M', '28.4%'],
      ['Floor Cleaner', 'Household', '$38M', '25.7%'],
      ['BrandE Yogurt (Straw)', 'Dairy', '$35M', '23.6%'],
      ['Aloe Face Wash', 'Personal Care', '$32M', '21.6%'],
      ['Fabric Softener', 'Household', '$28M', '18.9%']
    ]
  },
  'Avg Complexity': {
  ...
  'Portfolio Revenue': {
    ...
    value: '$851.4M',
    soWhat: 'Month-to-date total portfolio revenue is $851.4M, tracking slightly behind the target of $900M. Top-line velocity remains heavily supported by the Beverages segment (37.1%), while minor supply chain bottlenecks in Personal Care introduce slight margin exposure.',
    ...
    assumptions: [
      'Target baseline: The target of $900M is set based on historical seasonal runs and Q2 category forecasts.',
  ...
  'Assortment Gross Yield': {
    ...
    value: '$3.02M',
    soWhat: 'Average gross profit contribution per active listing is $3.02M, lagging behind the $3.50M corporate benchmark by -1.1% due to promo dependency.',
    ...
    trendRows: [
      ['Supermarkets', '$3.12M', '+1.2%', 'On Target'],
      ['Hypermarkets', '$3.05M', '-0.5%', 'Borderline'],
      ['E-commerce', '$2.98M', '-2.4%', 'Underperforming'],
      ['Convenience', '$2.88M', '-3.1%', 'Critical']
    ]
  },
  ...
  'Portfolio Health Score': {
    ...
    trendRows: [
      ['Introduction', '12 SKUs', '$12.5M (9%)', 'Healthy / Launching'],
      ['Growth', '28 SKUs', '$45.2M (34%)', 'Optimal / High Growth'],
      ['Maturity', '45 SKUs', '$62.1M (47%)', 'Stable / Cash Cow'],
      ['Decline', '23 SKUs', '$13.2M (10%)', 'Elevated Risk / Tail Drag']
    ]
  }
};
