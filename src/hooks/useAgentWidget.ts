...
• Beverages: BrandF Water ($17.03 M)
• Snacks: BrandC Chips ($16.00 M)
• Personal Care: BrandC Toothpaste ($12.97 M)
• Dairy: BrandD Cheese ($11.20 M)
• Home Care: BrandB Detergent ($9.20 M)
...
Geographically, Italy's top seller is BrandF Water, while Spain is led by BrandC Chips and Germany by BrandB Chips.`;
          ...
          replyText = `Based on our multi-country sales data, our best performing SKU by Net Sales is BrandF Water ($17.03 M) and by Gross Margin is also BrandF Water ($6.83 M), followed closely by BrandC Chips ($16.00 M).`;
