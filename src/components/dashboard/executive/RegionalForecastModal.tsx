...
Following our Q2 regional review of the APAC region (which is overperforming by +7.6% at $312M), we are facing capacity bottlenecks for our high-demand SKUs. 
...
Our convenience channel in APAC is growing at +15% WoW but remains under-allocated in promotional spend (contributing only $35M of the $312M actuals).
...
Executive Director`
      ...
      insights = [
        ...
        'Supply chain bottleneck: Fabric Softener (Vapi Hub) recorded 7 major stockouts, causing $6.2M in lost demand.',
...
The Americas region has fallen short of target by -5.0% (actual $228M vs target $240M). A primary driver is margin compression in hypermarkets, particularly on Choco Wafers.
...
EMEA performance is stable (+2.0% actual $311M), but supplier complexity is introducing container delay risks. 
