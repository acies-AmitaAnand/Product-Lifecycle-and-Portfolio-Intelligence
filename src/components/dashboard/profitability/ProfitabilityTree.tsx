...
const breakevenSKUs = [
  { name: 'Fabric Softener', detail: 'Household · Rev $28M', margin: 15, color: '#ef4444' },
  { name: 'Floor Cleaner', detail: 'Household · Rev $30M', margin: 19, color: '#f59e0b' },
];
      ...
      <div className="p-4 bg-gradient-to-r from-purple-500/10 to-indigo-500/10 border-l-4 border-[#8b5cf6] dark:border-purple-400 rounded-r shadow-sm flex items-start gap-3">
        ...
        <div className="space-y-0.5">
          ...
          <p className="text-[11px] font-medium leading-relaxed text-zinc-700 dark:text-zinc-300">
            Portfolio gross margin increased <span className="text-emerald-500 font-extrabold">+1.1pp to 36.2%</span>. Total P&L leakage cost of <span className="text-[#8b5cf6] font-extrabold">$64M</span> represents 7.5% of total revenue. Promo erosion is high, with <span className="text-red-500 font-extrabold">{activeErosionPromos} active campaigns</span> destroying margin.
          </p>
        </div>
      </div>
