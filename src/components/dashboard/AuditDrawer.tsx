                  ...
                  <div className="space-y-5">
                    ...
                    <div className="bg-purple-500/5 border border-purple-500/15 rounded-xl p-4.5 space-y-3 shadow-sm">
                      ...
                      <ul className="space-y-2.5 pl-4 list-disc text-[11.5px] leading-relaxed text-zinc-650 dark:text-zinc-300">
                        ...
                        <li className="marker:text-purple-500"><strong>India Leads Growth:</strong> Best-performing region with <span className="font-bold text-green-650 dark:text-green-400">$320M (+15% YoY)</span>.</li>
                        <li className="marker:text-purple-500"><strong>Americas Underperforms:</strong> Worst-performing region with <span className="font-bold text-red-500">$180M (−6.4% YoY)</span>.</li>
