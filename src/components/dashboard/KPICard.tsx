...
const KPI_TOOLTIPS: Record<string, { soWhat: string; action: string }> = {
  ...
  'Gross Profit': {
    soWhat: 'Gross profit reached $308.1M, driven by strong volumes in carbonated beverages and snacks.',
    action: 'Optimize supply chain logistics to reduce supplier COGS and protect the margins.'
  },
  'Revenue MTD': {
    soWhat: 'MTD revenue reaches $851.2M (8.4% increase vs last month), driven by a demand surge in natural beverages.',
...
const KPI_METRIC_CONFIGS: Record<string, { target: string; color: string; hist: number[] }> = {
  ...
  // Profitability
  'Net Profit': { target: '$100M', color: '#10b981', hist: [85, 88, 90, 92, 93, 94, 94.8, 95.2] },
  'Gross margin %': { target: '38%', color: '#3b82f6', hist: [35.1, 35.4, 35.6, 35.8, 36.0, 36.1, 36.2, 36.2] },
  'Gross Profit': { target: '$320M', color: '#10b981', hist: [290, 295, 300, 302, 304, 306, 307.5, 308.1] },
  'Revenue MTD': { target: '$900M', color: '#3b82f6', hist: [780, 795, 808, 821, 833, 843, 850, 851.2] },
